	...
	void DrawMap(){
		foreach (Room room in rooms)
		{
			...
			string doors = "";
				...
				GameObject[] thing = GetTile(doors);
				
			GameObject tile = Object.Instantiate(thing[Random.Range(0,thing.Length)], drawPos, Quaternion.identity);
			tile.transform.parent = GameObject.FindGameObjectWithTag("Grid").transform;
